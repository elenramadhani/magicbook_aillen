...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // ? Instruksi 3: Konversi input menjadi String dan tampung di dalam variabel output
      // >>> Tulis jawabanmu di bawah ini
      double intput = 3.14159;
      String? output;
      output = intput.toString();
      // --- End of Answer ---
      return output == "3.14159";
    },
    // Exercise 100
    ...
    () {
      ...
      List<String> input = ["apple", "banana", "cherry"];
      bool? output;
      output = input.join(' ').contains("grape");
      // --- End of Answer ---
    ...
    () {
      ...
      List<String> output = [];
      for (int item in input) output.add(item.toString());
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      Map<int, String> input = {3: "apple", 2: "banana"};
    ...
    () {
      ...
      List<int> output = [];
      for (Map<String, int> item in input) output.addAll(item.values.toList());
    ...
    () {
      ...
      List<bool> output = [];
      for (String item in input.split(",")) output.add(bool.parse(item));
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      String input = "apple,banana,cherry";
      Map<String, int> output = {for (String item in input.split(",")) item: 1};
      // --- End of Answer ---
    ...
    () {
      ...
      Map<int, String> output = {
        for (String item in input.split(",")) int.parse(item): "value"
      };
      // --- End of Answer ---
    ...
    () {
      ...
      Map<int, int>? output;
      output =
          input.asMap().map((key, value) => MapEntry(key + 1, value * value));
      // --- End of Answer ---
    ...
    () {
      ...
      List<String>? output;
      output = input.map((item) => item["fruit"] as String).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      List<int>? output;
      output = input.map((item) => item["amount"]!).toList();
    ...
    () {
      ...
      List<int>? output;
      output = input.map((item) => item["value"] as int).toList();
    ...
    () {
      ...
      List<int>? output;
      output = input.map((item) => int.parse(item)).toList();
    ...
    () {
      ...
      List<int>? output;
      output = input.split(',').map((item) => int.parse(item)).toList();
    ...
    () {
      ...
      List<double>? output;
      output = input.split(',').map((item) => double.parse(item)).toList();
    ...
    () {
      ...
      List<bool>? output;
      output =
          input.split(',').map((item) => item.toLowerCase() == 'true').toList();
    ...
    () {
      ...
      List<String>? output;
      output = input.split(',').map((item) => item.trim()).toList();
    ...
    () {
      ...
      List<DateTime>? output;
      output = input.split(',').map((item) => DateTime.parse(item)).toList();
    ...
    () {
      ...
      for (String entry in entries) {
        ...
        output[parts[0]] = double.parse(parts[1]);
      }
      // --- End of Answer ---
    ...
    () {
      ...
      input.split(",").forEach((element) {
        ...
        output![parts[0]] = DateTime.parse(parts[1]);
      });
      // --- End of Answer ---
    ...
    */
    ...
    () {
      ...
      bool? output = input.isNotEmpty && input[0] == "D";
    ...
    () {
      ...
      bool? output =
          input.isNotEmpty && input[input.length - 1].toLowerCase() == 't';
    ...
    () {
      ...
      bool? output = input >= 10000 && input <= 99999;
    ...
    () {
      ...
      bool? output = input >= 1000 && input <= 9999;
    ...
    () {
      ...
      if (decimalIndex != -1 && inputString.length - decimalIndex - 1 == 2)
        return output == true;
    },
    ...
    () {
      ...
      if (decimalIndex != -1 && inputString.length - decimalIndex - 1 == 3)
        return output == false;
    },
    ...
    () {
      ...
      String output = text.substring(4, text.length - 8);
      return output == " is awesome";
    },
    ...
    () {
      ...
      bool output = text.contains("awesome");
      return output;
    },
    ...
    () {
      ...
      bool containsX = text.contains("x");
      bool containsA = text.contains("a");
      return output == false;
    },
    ...
    () {
      ...
      String combinedText = text + "and Flutter";
    ...
    () {
      ...
      int output = numbers.where((number) => number.isEven).first;
      return output == 2;
    },
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
       for (var employee in employees) {
        var lastName = employee["name"].split(" ").last;
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
       for (var employee in employees) {
        if (employee["age"] < 30 &&
            employee["name"].split(" ").last.contains("son")) {
          matchedEmployees.add(employee);
        }
      }
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        if (products[i]["isFeatured"] == true &&
            products[i]["rating"] > 4.5 &&
            products[i]["isAvailable"] == true &&
            products[i]["reviews"] > 100) {
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
       for (int i = 0; i < employees.length; i++) {
        if (employees[i]["isFullTime"] == false &&
            employees[i]["hasHealthInsurance"] == false &&
            employees[i]["age"] < 25) {
